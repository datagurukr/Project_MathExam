...
class Purchase extends CI_Controller {
    ...
    function index ( $p = 0 ) {        
        ...
        *******************/             
        ...
        $result = $this->purchase_model->out('all',array(
            'user_id' => $session_id,
            'p' => $p,
            'q' => $q,
            'order' => 'desc',
        ...
        $result_count = $this->purchase_model->out('all',array(
            'user_id' => $session_id,
            'p' => $p,
            'q' => $q,
            'order' => 'desc',            
        ...
        $this->global_pagination($pagination_count,'/admin/purchase/?',$pagination_url);                        
