...
<div class="col-xs-10 col-xs-offset-2 main">
  <h1 class="page-header">경매완료 차량</h1>
    ...
    <table class="table table table-bordered text-center">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <a href="/admin/salesapproval/editor/<? echo $row['car_id']; ?>/complete" class="btn btn-primary btn-xs">판매완료</a>  
          </td>
          <td>
            <a href="/admin/salesapproval/editor/<? echo $row['car_id']; ?>/standby" class="btn btn-danger btn-xs">판매승인</a>  
          </td>
        </tr>
                        <?
                    }
