        ...
        <form class="col s12">
                    ...
                    <table class="striped centered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><? echo $num; $num--; ?></td>
                                <td>
                                    <a href="/admin/notice/edit/<? echo $row['post_id']; ?>?referer=/admin/notice?p=<? echo $p; ?>">
                                        <?
                                ...
                                <td>
                                    ...
                                    <div id="modal<? echo $row['post_id']; ?>" class="modal">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a class="modal-action modal-close waves-effect waves-green btn-flat" onclick="location.href='/admin/notice/<? echo $row['post_id']; ?>/delete?referer=/admin/notice?p=<? echo $p; ?>'">승인</a>
                                        </div>
                                    </div>                                    
                                </td>
                            </tr>
            ...
            <div class="row">
                <div class="input-field col s12 right-align">
                    <a href="/admin/notice/edit?referer=/admin/notice?p=<? echo $p; ?>" class="waves-effect waves-light btn">생성</a>
                </div>
            </div>
        </form>
    </div>
